    ...
    mostrarNoticias() {
        ...
        function procesarNoticias(noticias) {
            ...
            for (const noticia of noticias) {
                ...
                var descripcionTexto = (noticia.description || '').normalize("NFC");
                
                // Por si la descripción es muy larga
                if (descripcionTexto.length > 500)
                    descripcionTexto = descripcionTexto.slice(0, 500).trim() + '...';
                
                const descripcion = $('<p>').text(descripcionTexto);
                ...
                if(noticia.image_url) {
                    ...
                    articleNoticias.append(titulo, descripcion);
                }
            }
        }

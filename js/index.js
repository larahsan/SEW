    ...
    mostrarNoticias() {
        ...
        function procesarNoticias(noticias) {
            ...
            for (const noticia of noticias) {
                ...
                const maxLongitud = 500; // Por si la descripción es muy larga
                if (descripcionTexto.length > maxLongitud)
                    descripcionTexto = descripcionTexto.slice(0, maxLongitud).trim() + '...';
